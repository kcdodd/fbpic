...
add_cubic_gather_for_mode = cuda.jit( add_cubic_gather_for_mode,
                                        device=True, inline=True )
add_linear_gather_for_mode_scalar = cuda.jit( add_linear_gather_for_mode_scalar,
                                        device=True, inline=True )
add_cubic_gather_for_mode_scalar = cuda.jit( add_cubic_gather_for_mode_scalar,
                                        device=True, inline=True )
...
@cuda.jit
def gather_scalar_gpu_linear(x, y, z,
                    rmax_gather,
                    invdz, zmin, Nz,
                    invdr, rmin, Nr,
                    Ez_m0,
...
@cuda.jit
def gather_scalar_gpu_cubic(x, y, z,
                    rmax_gather,
                    invdz, zmin, Nz,
                    invdr, rmin, Nr,
                    Ez_m0,
